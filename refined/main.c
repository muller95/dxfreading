    ...
    while (filenames_list != NULL) {
        ...
        if (check_if_opened(filename)) {
          ...
          continue;
	    	...
	    	dxf_file_create(filename, &dxf_file, quant_files);
    ...
    switch (column) {
        case COLUMN_ITEM_QUANT: 
            ...
            if (atoi(new_text) > 0) {
                ...
                dxf_files[num - 1].quant = atoi(new_text);
            }
...
int main (int argc, char *argv[])
{
	...
	GtkCellRenderer *renderer;
    	char *item1 = "file", *subitem1 = "open", *subitem2 = "rect nest", *subitem3 = "nfp nest polygons";
